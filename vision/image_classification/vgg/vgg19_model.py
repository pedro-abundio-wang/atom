...
def vgg19(num_classes,
    ...
    x = vgg_block(x, size=5, filters=256, stage='3')
    x = vgg_block(x, size=5, filters=512, stage='4')
    x = vgg_block(x, size=5, filters=512, stage='5')
    ...
    # Create model.
    return models.Model(img_input, x, name='vgg19')
