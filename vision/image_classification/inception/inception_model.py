...
def factorization_inception_block(input_tensor,
                                  num1x1,
                                  num3x3_reduce,
                                  num3x3,
                                  num5x5_reduce,
    ...
    branch5x5 = layers.Conv2D(
        ...
        kernel_initializer='he_normal',
        kernel_regularizer=regularizers.l2(L2_WEIGHT_DECAY),
        name=name_base + '_factor_conv5x5')(branch5x5)
    branch5x5 = layers.BatchNormalization(
        axis=channel_axis,
    ...
    branch5x5 = layers.Conv2D(
        ...
        kernel_initializer='he_normal',
        kernel_regularizer=regularizers.l2(L2_WEIGHT_DECAY),
        name=name_base + 'factor_conv5x5_')(branch5x5)
    branch5x5 = layers.BatchNormalization(
        axis=channel_axis,
        name=name_base + '_bn5x5_')(branch5x5)
    branch5x5 = layers.Activation('relu')(branch5x5)
...
def asymmetric_inception_block(input_tensor,
                               num1x1,
                               num3x3_reduce,
                               num3x3,
                               num5x5_reduce,
...
def inception(num_classes,
    ...
    # Create model.
    return models.Model(img_input, x, name='inception')
